...
public class CustomerController {
	...
	public String showFormForAdd(Model theModel) {
		...
		theCustomer.setCustomerDetail(new CustomerDetail());
	...
	public String showFormForAddDetail(Model theModel) {
	...
	public String saveCustomerDetail(@ModelAttribute("customerDetail") CustomerDetail theCustomerDetail) {
	...
	public String listCustomerDetails(Model theModel) {
		...
		List<CustomerDetail> theCustomerDetails = customerService.getCustomerDetails();
				
		// add the customers to the model
		theModel.addAttribute("customerDetails", theCustomerDetails);
